...
(function initThemeToggle() {
  ...
  // Se o usuário salvou uma preferência no localStorage, usa ela;
  // senão respeita o data-theme já definido no HTML (padrão 'light').
  ...
  function updateThemeIcon(btn, theme) {
    if (theme === 'light') {
      // Mostra ícone de Lua (para alternar para o escuro)
      ...
      // Mostra ícone de Sol (para alternar para o claro)
